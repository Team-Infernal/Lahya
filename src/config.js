	...
	"terms": [
		{
			...
			<div>
				...
				<div>
					<p>By accessing this website we assume you accept these terms and conditions. Do not continue to use Lahya if you do not agree to take all of the terms and conditions stated on this page.</p>
				</div>
				<div>
		...
		},
		{
			...
			<div>
				...
				<div>
					<ul>
						<li>Republish material from Lahya</li>
						<li>Sell, rent or sub-license material from Lahya</li>
						<li>Reproduce, duplicate or copy material from Lahya</li>
						<li>Redistribute content from Lahya</li>
					</ul>
				</div>
				<div>
				...
				<div>
					<p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain areas of the website. Lahya does not filter, edit, publish or review Comments prior to their presence on the website. Comments do not reflect the views and opinions of Lahya,its agents and/or affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To the extent permitted by applicable laws, Lahya shall not be liable for the Comments or for any liability, damages or expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.</p>
				</div>
				<div>
					<p>Lahya reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate, offensive or causes breach of these Terms and Conditions.</p>
				</div>
				<div>
				...
				<div>
					<p>You hereby grant Lahya a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.</p>
				</div>
				<div>
			...
			<div>
				...
				<div>
					<ul>
						...
						<li>and (c) fits within the context of the linking party’s site.</li>
					</ul>
				</div>
				<div>
				...
				<div>
					<ul>
						...
						<li>(c) the benefit to us from the visibility of the hyperlink compensates the absence of Lahya;</li>
						<li>and (d) the link is in the context of general resource information.</li>
					</ul>
				</div>
				<div>
	...
	"privacy": [
			...
			<div>
				...
				<div>
					<ul>
						...
						<li>Company (referred to as either the Company, We, Us or Our in this agreement) refers to Lahya.</li>
						...
						<li>Country refers to: France</li>
		...
		},
		{
			...
			<div>
				...
				<div>
					<p>Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. Learn more about cookies: https://www.privacypolicies.com/blog/privacy-policy-template.</p>
